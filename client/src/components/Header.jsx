    ...
    const drawer = (
        <Box onClick={handleDrawerToggle} sx={{ textAlign: 'center' }}>
            ...
            <List>
                ...
                {isAuthenticated && <ListItem disablePadding>
                    <ListItemButton sx={{ textAlign: 'center' }} onClick={handleUserLogout}>
            ...
            <AppBar component="nav" color={`${isAuthenticated ? 'secondary': 'primary'}`}>
                <Toolbar>
                    ...
                    <Box sx={{ display: { xs: 'none', sm: 'block' } }}>
                        ...
                        {!isAuthenticated && <Button sx={{ color: '#fff' }} component={NavLink} to="/login">
                            Login
                        </Button>}
                        {isAuthenticated && <Button sx={{ color: '#fff' }} onClick={handleUserLogout}>
                            Logout
                        </Button>}
                    </Box>
                </Toolbar>
